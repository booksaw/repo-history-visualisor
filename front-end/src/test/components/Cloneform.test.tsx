...
test("Test loading into visualisation", () => {
    ...
    const JSONData = jest.spyOn(BackEndCommunicator, "loadJSONData").mockImplementation(async () => { });

    render(<CloneForm setErrorText={() => { }} setVisData={() => { }} setDebugMode={() => { }} setDisplayForm={() => { }} setManualMode={() => { }} />)
...
test("Test submitting valid data", () => {
    ...
    let { container, getByPlaceholderText } = render(<CloneForm setErrorText={() => { }} setVisData={() => { }} setDebugMode={() => { }} setDisplayForm={() => { }} setManualMode={() => { }} />)
